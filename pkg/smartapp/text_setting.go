...
func (m *TextSetting) UnmarshalJSON(raw []byte) error {
	...
	m.MaxLength = dataAO1.MaxLength

	m.MinLength = dataAO1.MinLength
...
func (m TextSetting) MarshalJSON() ([]byte, error) {
	...
	dataAO1.MaxLength = m.MaxLength

	dataAO1.MinLength = m.MinLength
...
func (m *TextSetting) validateImage(formats strfmt.Registry) error {
...
func (m *TextSetting) validatePostMessage(formats strfmt.Registry) error {
