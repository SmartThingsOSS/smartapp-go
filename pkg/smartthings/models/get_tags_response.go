...
// GetTagsResponse A response object containing the resource's tags.
// swagger:model GetTagsResponse
...
func (m *GetTagsResponse) validateTags(formats strfmt.Registry) error {
