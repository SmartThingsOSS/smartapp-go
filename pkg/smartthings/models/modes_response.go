...
// ModesResponse modes response
// swagger:model ModesResponse
...
func (m *ModesResponse) validateItems(formats strfmt.Registry) error {
	...
	if err := validate.MaxItems("items", "body", iItemsSize, 10); err != nil {
		return err
	}
