...
// PatchTagsResponse A response object containing the updated tags.
// swagger:model PatchTagsResponse
...
func (m *PatchTagsResponse) validateTags(formats strfmt.Registry) error {
